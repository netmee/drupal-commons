 ...
 *  $databases['default']['default'] = array(
 *    'driver' => 'mysql',
 *    'database' => getenv('DIGITAL_MYSQL_DB_NAME'),
 *    'username' => getenv('DIGITAL_MYSQL_DB_USER'),
 *    'password' => getenv('DIGITAL_MYSQL_DB_PASSWORD'),
 *    'host' => getenv('DIGITAL_MYSQL_DB_HOST'),
 *    'port' => getenv('DIGITAL_MYSQL_DB_PORT'),
 *    'prefix' => '',
 *  );                                                 
 * @endcode                                                                     
 */
